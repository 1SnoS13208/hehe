...
public class SelectGraphicScene {
    ...
    private Label graphicDisplayLabelToUpdate; 
    ...
    public SelectGraphicScene(SceneManager sceneManager, Label graphicDisplayLabel) {
        ...
        this.tempSelectedGraphic = sceneManager.getGraphic(); 
    }
    ...
    public Parent createContent() {
        ...
        try {
            ...
            System.err.println("Lỗi tải ảnh nền cho SelectGraphicScene: " + imagePath + " - " + e.getMessage());
        ...
        graphicvariantsContainer.setMaxWidth(380); 
